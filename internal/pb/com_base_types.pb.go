...
type PlayerSceneInfo struct {
	...
	SceneResCfgId                     *uint32                `protobuf:"varint,6,opt,name=scene_res_cfg_id,json=sceneResCfgId" json:"scene_res_cfg_id,omitempty"`
	...
	EnterSceneContinuousFailCount     *int32                 `protobuf:"varint,15,opt,name=enter_scene_continuous_fail_count,json=enterSceneContinuousFailCount" json:"enter_scene_continuous_fail_count,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
func (x *PlayerSceneInfo) GetSceneResCfgId() uint32 {
	if x != nil && x.SceneResCfgId != nil {
		return *x.SceneResCfgId
	}
	return 0
}
...
func (x *PlayerSceneInfo) GetEnterSceneContinuousFailCount() int32 {
	if x != nil && x.EnterSceneContinuousFailCount != nil {
		return *x.EnterSceneContinuousFailCount
	}
	return 0
}
...
const file_com_base_types_proto_rawDesc = "" +
	...
	"%kickout_type_when_scenesvr_recovering\x18\x05 \x01(\x05R!kickoutTypeWhenScenesvrRecovering\x12'\n" +
	"\x10scene_res_cfg_id\x18\x06 \x01(\rR\rsceneResCfgId\x12O\n" +
	...
	"\tcurr_time\x18\x0e \x01(\x03R\bcurrTime\x12H\n" +
	"!enter_scene_continuous_fail_count\x18\x0f \x01(\x05R\x1denterSceneContinuousFailCount\"g\n" +
