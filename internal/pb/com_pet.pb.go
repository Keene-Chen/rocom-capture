...
type PetBoxFilterSource int32

const (
	PetBoxFilterSource_PBFS_NONE      PetBoxFilterSource = 0
	PetBoxFilterSource_PBFS_MANUAL    PetBoxFilterSource = 1
	PetBoxFilterSource_PBFS_AI        PetBoxFilterSource = 2
	PetBoxFilterSource_PBFS_MANUAL_AI PetBoxFilterSource = 3
)

// Enum value maps for PetBoxFilterSource.
var (
	PetBoxFilterSource_name = map[int32]string{
		0: "PBFS_NONE",
		1: "PBFS_MANUAL",
		2: "PBFS_AI",
		3: "PBFS_MANUAL_AI",
	}
	PetBoxFilterSource_value = map[string]int32{
		"PBFS_NONE":      0,
		"PBFS_MANUAL":    1,
		"PBFS_AI":        2,
		"PBFS_MANUAL_AI": 3,
...
func (x PetBoxFilterSource) Enum() *PetBoxFilterSource {
	p := new(PetBoxFilterSource)
	*p = x
	return p
}

func (x PetBoxFilterSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PetBoxFilterSource) Descriptor() protoreflect.EnumDescriptor {
	return file_com_pet_proto_enumTypes[5].Descriptor()
}

func (PetBoxFilterSource) Type() protoreflect.EnumType {
	return &file_com_pet_proto_enumTypes[5]
}

func (x PetBoxFilterSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *PetBoxFilterSource) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = PetBoxFilterSource(num)
	return nil
}

// Deprecated: Use PetBoxFilterSource.Descriptor instead.
func (PetBoxFilterSource) EnumDescriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{5}
}

type PetFreeType int32

const (
	PetFreeType_PFT_NONE                 PetFreeType = 0
	PetFreeType_PFT_MANUAL_DRAG          PetFreeType = 1
	PetFreeType_PFT_MANUAL_CHECK         PetFreeType = 2
	PetFreeType_PFT_AI_CHECK             PetFreeType = 3
	PetFreeType_PFT_CUR_PAGE_QUICK       PetFreeType = 4
	PetFreeType_PFT_TALENT_NORMAL_QUICK  PetFreeType = 5
	PetFreeType_PFT_TALENT_GOOD_QUICK    PetFreeType = 6
	PetFreeType_PFT_TALENT_AMAZING_QUICK PetFreeType = 7
)

// Enum value maps for PetFreeType.
var (
	PetFreeType_name = map[int32]string{
		0: "PFT_NONE",
		1: "PFT_MANUAL_DRAG",
		2: "PFT_MANUAL_CHECK",
		3: "PFT_AI_CHECK",
		4: "PFT_CUR_PAGE_QUICK",
		5: "PFT_TALENT_NORMAL_QUICK",
		6: "PFT_TALENT_GOOD_QUICK",
		7: "PFT_TALENT_AMAZING_QUICK",
	}
	PetFreeType_value = map[string]int32{
		"PFT_NONE":                 0,
		"PFT_MANUAL_DRAG":          1,
		"PFT_MANUAL_CHECK":         2,
		"PFT_AI_CHECK":             3,
		"PFT_CUR_PAGE_QUICK":       4,
		"PFT_TALENT_NORMAL_QUICK":  5,
		"PFT_TALENT_GOOD_QUICK":    6,
		"PFT_TALENT_AMAZING_QUICK": 7,
	}
)

func (x PetFreeType) Enum() *PetFreeType {
	p := new(PetFreeType)
	*p = x
	return p
}

func (x PetFreeType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PetFreeType) Descriptor() protoreflect.EnumDescriptor {
	return file_com_pet_proto_enumTypes[6].Descriptor()
}

func (PetFreeType) Type() protoreflect.EnumType {
	return &file_com_pet_proto_enumTypes[6]
}

func (x PetFreeType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *PetFreeType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
...
// Deprecated: Use PetFreeType.Descriptor instead.
func (PetFreeType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PetTypeInfo_PET_TYPE_GM_INVINCIBLE PetTypeInfo_ENUM = 6
	PetTypeInfo_PET_TYPE_AI_TRIAL      PetTypeInfo_ENUM = 7
)
...
func (PetTypeInfo_ENUM) Descriptor() protoreflect.EnumDescriptor {
	return file_com_pet_proto_enumTypes[7].Descriptor()
}

func (PetTypeInfo_ENUM) Type() protoreflect.EnumType {
	return &file_com_pet_proto_enumTypes[7]
}
...
type PetNameDetailData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NameSrc       *PetNameSource         `protobuf:"varint,1,opt,name=name_src,json=nameSrc,enum=dataconfig.PetNameSource" json:"name_src,omitempty"`
	PetName       []byte                 `protobuf:"bytes,2,opt,name=pet_name,json=petName" json:"pet_name,omitempty"`
	PetBaseId     *uint32                `protobuf:"varint,3,opt,name=pet_base_id,json=petBaseId" json:"pet_base_id,omitempty"`
	ConfId        *uint32                `protobuf:"varint,4,opt,name=conf_id,json=confId" json:"conf_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PetNameDetailData) Reset() {
	*x = PetNameDetailData{}
...
func (x *PetNameDetailData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PetNameDetailData) ProtoMessage() {}

func (x *PetNameDetailData) ProtoReflect() protoreflect.Message {
	mi := &file_com_pet_proto_msgTypes[74]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PetNameDetailData.ProtoReflect.Descriptor instead.
func (*PetNameDetailData) Descriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{74}
}

func (x *PetNameDetailData) GetNameSrc() PetNameSource {
	if x != nil && x.NameSrc != nil {
		return *x.NameSrc
	}
	return PetNameSource_PNS_PET_BASE
...
func (x *PetNameDetailData) GetPetName() []byte {
	if x != nil {
		return x.PetName
	}
	return nil
...
func (x *PetNameDetailData) GetPetBaseId() uint32 {
	if x != nil && x.PetBaseId != nil {
		return *x.PetBaseId
	}
	return 0
...
func (x *PetNameDetailData) GetConfId() uint32 {
	if x != nil && x.ConfId != nil {
		return *x.ConfId
	}
	return 0
...
func (x *PetLordInfo) Reset() {
	*x = PetLordInfo{}
	mi := &file_com_pet_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PetLordInfo) Descriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{75}
}
...
type ColorInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ColorId       *uint32                `protobuf:"varint,1,opt,name=color_id,json=colorId" json:"color_id,omitempty"`
	ValidMsTime   *int64                 `protobuf:"varint,2,opt,name=valid_ms_time,json=validMsTime" json:"valid_ms_time,omitempty"`
	ObjId         *uint64                `protobuf:"varint,3,opt,name=obj_id,json=objId" json:"obj_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ColorInfo) Reset() {
	*x = ColorInfo{}
	mi := &file_com_pet_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ColorInfo) Descriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{76}
}

func (x *ColorInfo) GetColorId() uint32 {
...
func (x *ColorInfo) GetValidMsTime() int64 {
	if x != nil && x.ValidMsTime != nil {
		return *x.ValidMsTime
	}
	return 0
}

func (x *ColorInfo) GetObjId() uint64 {
...
type GlassColorRandomInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ColorList     []*ColorInfo           `protobuf:"bytes,1,rep,name=color_list,json=colorList" json:"color_list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GlassColorRandomInfo) Reset() {
	*x = GlassColorRandomInfo{}
	mi := &file_com_pet_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GlassColorRandomInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlassColorRandomInfo) ProtoMessage() {}

func (x *GlassColorRandomInfo) ProtoReflect() protoreflect.Message {
	mi := &file_com_pet_proto_msgTypes[77]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlassColorRandomInfo.ProtoReflect.Descriptor instead.
func (*GlassColorRandomInfo) Descriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{77}
}

func (x *GlassColorRandomInfo) GetColorList() []*ColorInfo {
	if x != nil {
		return x.ColorList
	}
	return nil
...
type PetBoxFilterItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rule          *FilterRule            `protobuf:"varint,1,opt,name=rule,enum=dataconfig.FilterRule" json:"rule,omitempty"`
	Values        []uint32               `protobuf:"varint,2,rep,name=values" json:"values,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PetBoxFilterItem) Reset() {
	*x = PetBoxFilterItem{}
	mi := &file_com_pet_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PetBoxFilterItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PetBoxFilterItem) ProtoMessage() {}

func (x *PetBoxFilterItem) ProtoReflect() protoreflect.Message {
	mi := &file_com_pet_proto_msgTypes[78]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PetBoxFilterItem.ProtoReflect.Descriptor instead.
func (*PetBoxFilterItem) Descriptor() ([]byte, []int) {
	return file_com_pet_proto_rawDescGZIP(), []int{78}
}

func (x *PetBoxFilterItem) GetRule() FilterRule {
	if x != nil && x.Rule != nil {
		return *x.Rule
	}
	return FilterRule_FIL_LEARNABLE
}

func (x *PetBoxFilterItem) GetValues() []uint32 {
	if x != nil {
		return x.Values
	}
	return nil
...
const file_com_pet_proto_rawDesc = "" +
	...
	"\x04pets\x18\x02 \x03(\v2\r.Next.PetDataR\x04pets\"\x8f\x02\n" +
	"\vPetTypeInfo\x12*\n" +
	"\x04type\x18\x01 \x01(\x0e2\x16.Next.PetTypeInfo.ENUMR\x04type\x12\x14\n" +
	"\x05param\x18\x02 \x01(\x05R\x05param\"\xbd\x01\n" +
	"\x04ENUM\x12\x13\n" +
	...
	"\x10PET_TYPE_BUFF145\x10\x05\x12\x1a\n" +
	"\x16PET_TYPE_GM_INVINCIBLE\x10\x06\x12\x15\n" +
	"\x11PET_TYPE_AI_TRIAL\x10\a\"\x88\x01\n" +
	...
	"\x06energy\x18\x1d \x01(\x05R\x06energy\"\x9d\x01\n" +
	"\x11PetNameDetailData\x124\n" +
	"\bname_src\x18\x01 \x01(\x0e2\x19.dataconfig.PetNameSourceR\anameSrc\x12\x19\n" +
	"\bpet_name\x18\x02 \x01(\fR\apetName\x12\x1e\n" +
	"\vpet_base_id\x18\x03 \x01(\rR\tpetBaseId\x12\x17\n" +
	"\aconf_id\x18\x04 \x01(\rR\x06confId\"\xb0\x02\n" +
	"\vPetLordInfo\x12,\n" +
	...
	"\x15before_skill_dam_type\x18\x06 \x03(\x0e2\x18.dataconfig.SkillDamTypeR\x12beforeSkillDamType\"a\n" +
	"\tColorInfo\x12\x19\n" +
	"\bcolor_id\x18\x01 \x01(\rR\acolorId\x12\"\n" +
	"\rvalid_ms_time\x18\x02 \x01(\x03R\vvalidMsTime\x12\x15\n" +
	"\x06obj_id\x18\x03 \x01(\x04R\x05objId\"F\n" +
	"\x14GlassColorRandomInfo\x12.\n" +
	"\n" +
	"color_list\x18\x01 \x03(\v2\x0f.Next.ColorInfoR\tcolorList\"V\n" +
	"\x10PetBoxFilterItem\x12*\n" +
	"\x04rule\x18\x01 \x01(\x0e2\x16.dataconfig.FilterRuleR\x04rule\x12\x16\n" +
	"\x06values\x18\x02 \x03(\rR\x06values*f\n" +
	...
	"\x16PET_IN_TRIAL_CHALLENGE\x10\x80 *U\n" +
	"\x12PetBoxFilterSource\x12\r\n" +
	"\tPBFS_NONE\x10\x00\x12\x0f\n" +
	"\vPBFS_MANUAL\x10\x01\x12\v\n" +
	"\aPBFS_AI\x10\x02\x12\x12\n" +
	"\x0ePBFS_MANUAL_AI\x10\x03*\xc6\x01\n" +
	"\vPetFreeType\x12\f\n" +
	"\bPFT_NONE\x10\x00\x12\x13\n" +
	"\x0fPFT_MANUAL_DRAG\x10\x01\x12\x14\n" +
	"\x10PFT_MANUAL_CHECK\x10\x02\x12\x10\n" +
	"\fPFT_AI_CHECK\x10\x03\x12\x16\n" +
	"\x12PFT_CUR_PAGE_QUICK\x10\x04\x12\x1b\n" +
	"\x17PFT_TALENT_NORMAL_QUICK\x10\x05\x12\x19\n" +
	"\x15PFT_TALENT_GOOD_QUICK\x10\x06\x12\x1c\n" +
	"\x18PFT_TALENT_AMAZING_QUICK\x10\a"
...
var file_com_pet_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_com_pet_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_com_pet_proto_goTypes = []any{
	...
	(PetBoxFilterSource)(0),                     // 5: Next.PetBoxFilterSource
	(PetFreeType)(0),                            // 6: Next.PetFreeType
	(PetTypeInfo_ENUM)(0),                       // 7: Next.PetTypeInfo.ENUM
	(*PetAttributeData)(nil),                    // 8: Next.PetAttributeData
	(*PetAttributeInfo)(nil),                    // 9: Next.PetAttributeInfo
	(*PetAbilityData)(nil),                      // 10: Next.PetAbilityData
	(*PetAbilityInfo)(nil),                      // 11: Next.PetAbilityInfo
	(*BattleAIInitInfo)(nil),                    // 12: Next.BattleAIInitInfo
	(*Possession)(nil),                          // 13: Next.Possession
	(*PossessionInfo)(nil),                      // 14: Next.PossessionInfo
	(*PetStatistics)(nil),                       // 15: Next.PetStatistics
	(*PetEvoluteInfo)(nil),                      // 16: Next.PetEvoluteInfo
	(*PvpFirstWinInfo)(nil),                     // 17: Next.PvpFirstWinInfo
	(*LegendFirstWinAloneInfo)(nil),             // 18: Next.LegendFirstWinAloneInfo
	(*BlessingInfo)(nil),                        // 19: Next.BlessingInfo
	(*ObtainShinyFashionInfo)(nil),              // 20: Next.ObtainShinyFashionInfo
	(*PetBackTrackRecordInfo)(nil),              // 21: Next.PetBackTrackRecordInfo
	(*PetKeyExperience)(nil),                    // 22: Next.PetKeyExperience
	(*PetAdditionalNewAttrInfo)(nil),            // 23: Next.PetAdditionalNewAttrInfo
	(*PetAdditionalNewAttrList)(nil),            // 24: Next.PetAdditionalNewAttrList
	(*PetClosenessHistoryInfo)(nil),             // 25: Next.PetClosenessHistoryInfo
	(*PetClosenessInfo)(nil),                    // 26: Next.PetClosenessInfo
	(*DefeatInfo)(nil),                          // 27: Next.DefeatInfo
	(*InteractInfo)(nil),                        // 28: Next.InteractInfo
	(*PetEvolutionNeedInfo)(nil),                // 29: Next.PetEvolutionNeedInfo
	(*PetCheerPointInfo)(nil),                   // 30: Next.PetCheerPointInfo
	(*PetLLMTagHistoryInfo)(nil),                // 31: Next.PetLLMTagHistoryInfo
	(*PetLLMSingleNatureTagInfo)(nil),           // 32: Next.PetLLMSingleNatureTagInfo
	(*PetLLMNatureTagInfo)(nil),                 // 33: Next.PetLLMNatureTagInfo
	(*PetSceneInfo)(nil),                        // 34: Next.PetSceneInfo
	(*PetData)(nil),                             // 35: Next.PetData
	(*ActivityPartnerPetData)(nil),              // 36: Next.ActivityPartnerPetData
	(*TrialPetBrief)(nil),                       // 37: Next.TrialPetBrief
	(*TrialPet)(nil),                            // 38: Next.TrialPet
	(*PetTypeInfo)(nil),                         // 39: Next.PetTypeInfo
	(*PetSpecialityCondCheck)(nil),              // 40: Next.PetSpecialityCondCheck
	(*PetUseInfo)(nil),                          // 41: Next.PetUseInfo
	(*PetUseRate)(nil),                          // 42: Next.PetUseRate
	(*EnvEnergyInfo)(nil),                       // 43: Next.EnvEnergyInfo
	(*PetEnvEnergyInfo)(nil),                    // 44: Next.PetEnvEnergyInfo
	(*PetHpInfo)(nil),                           // 45: Next.PetHpInfo
	(*TogetherCatchInfo)(nil),                   // 46: Next.TogetherCatchInfo
	(*PetSpecialExData)(nil),                    // 47: Next.PetSpecialExData
	(*PetBriefInfo)(nil),                        // 48: Next.PetBriefInfo
	(*PetBacktrack)(nil),                        // 49: Next.PetBacktrack
	(*PetBacktrackShowInfo)(nil),                // 50: Next.PetBacktrackShowInfo
	(*PetUsedItems)(nil),                        // 51: Next.PetUsedItems
	(*PetBacktrackRoundInfo)(nil),               // 52: Next.PetBacktrackRoundInfo
	(*PetTravelInfo)(nil),                       // 53: Next.PetTravelInfo
	(*MutationCount)(nil),                       // 54: Next.MutationCount
	(*PetStatisticsInfo_PetStatisticsData)(nil), // 55: Next.PetStatisticsInfo_PetStatisticsData
	(*PetStatisticsInfo)(nil),                   // 56: Next.PetStatisticsInfo
	(*PetDataInfoList)(nil),                     // 57: Next.PetDataInfoList
	(*DeletedPetInfo)(nil),                      // 58: Next.DeletedPetInfo
	(*DeletedPetList)(nil),                      // 59: Next.DeletedPetList
	(*PetSpecialData)(nil),                      // 60: Next.PetSpecialData
	(*ReportInfo)(nil),                          // 61: Next.ReportInfo
	(*PetReportInfo)(nil),                       // 62: Next.PetReportInfo
	(*PetReportBriefInfo)(nil),                  // 63: Next.PetReportBriefInfo
	(*PetHabitGroup)(nil),                       // 64: Next.PetHabitGroup
	(*PetHabitInfo)(nil),                        // 65: Next.PetHabitInfo
	(*PetAdditionalAttrInfo)(nil),               // 66: Next.PetAdditionalAttrInfo
	(*PetCatchInfo)(nil),                        // 67: Next.PetCatchInfo
	(*PetBoxPetChange)(nil),                     // 68: Next.PetBoxPetChange
	(*PetBox)(nil),                              // 69: Next.PetBox
	(*PetBoxUnlockRecipe)(nil),                  // 70: Next.PetBoxUnlockRecipe
	(*PetBackpackInfo)(nil),                     // 71: Next.PetBackpackInfo
	(*BallInfo)(nil),                            // 72: Next.BallInfo
	(*CatchRateInfo)(nil),                       // 73: Next.CatchRateInfo
	(*ZoneCatchResult)(nil),                     // 74: Next.ZoneCatchResult
	(*PetSkillUseInfo)(nil),                     // 75: Next.PetSkillUseInfo
	(*RankSeasonPetUseInfo)(nil),                // 76: Next.RankSeasonPetUseInfo
	(*PlayerPetMonitorInfo)(nil),                // 77: Next.PlayerPetMonitorInfo
	(*PlayerPetMonitorDailyInfo)(nil),           // 78: Next.PlayerPetMonitorDailyInfo
	(*PetTaskInfo)(nil),                         // 79: Next.PetTaskInfo
	(*PetTogetherTaskInfo)(nil),                 // 80: Next.PetTogetherTaskInfo
	(*SceneBasePetData)(nil),                    // 81: Next.SceneBasePetData
	(*PetNameDetailData)(nil),                   // 82: Next.PetNameDetailData
	(*PetLordInfo)(nil),                         // 83: Next.PetLordInfo
	(*ColorInfo)(nil),                           // 84: Next.ColorInfo
	(*GlassColorRandomInfo)(nil),                // 85: Next.GlassColorRandomInfo
	(*PetBoxFilterItem)(nil),                    // 86: Next.PetBoxFilterItem
	(PetNameSource)(0),                          // 87: dataconfig.PetNameSource
	(SkillDamType)(0),                           // 88: dataconfig.SkillDamType
	(*PetSkillInfo)(nil),                        // 89: Next.PetSkillInfo
	(*CheerMonsterInitInfo)(nil),                // 90: Next.CheerMonsterInitInfo
	(PetPartnerMarkType)(0),                     // 91: dataconfig.PetPartnerMarkType
	(*GlassInfo)(nil),                           // 92: Next.GlassInfo
	(*SeasonBattleInfo)(nil),                    // 93: Next.SeasonBattleInfo
	(*OwlSanctuaryPetDiffInfo)(nil),             // 94: Next.OwlSanctuaryPetDiffInfo
	(*PetSkillData)(nil),                        // 95: Next.PetSkillData
	(ReportCoinRatio)(0),                        // 96: dataconfig.ReportCoinRatio
	(WarehouseMarkType)(0),                      // 97: dataconfig.WarehouseMarkType
	(PetBoxTidyRuleType)(0),                     // 98: dataconfig.PetBoxTidyRuleType
	(FilterRule)(0),                             // 99: dataconfig.FilterRule
}
var file_com_pet_proto_depIdxs = []int32{
	8,   // 0: Next.PetAttributeInfo.hp:type_name -> Next.PetAttributeData
	8,   // 1: Next.PetAttributeInfo.attack:type_name -> Next.PetAttributeData
	8,   // 2: Next.PetAttributeInfo.special_attack:type_name -> Next.PetAttributeData
	8,   // 3: Next.PetAttributeInfo.defense:type_name -> Next.PetAttributeData
	8,   // 4: Next.PetAttributeInfo.special_defense:type_name -> Next.PetAttributeData
	8,   // 5: Next.PetAttributeInfo.speed:type_name -> Next.PetAttributeData
	10,  // 6: Next.PetAbilityInfo.ability_data:type_name -> Next.PetAbilityData
	13,  // 7: Next.PossessionInfo.item:type_name -> Next.Possession
	87,  // 8: Next.BlessingInfo.from_pet_name_src:type_name -> dataconfig.PetNameSource
	16,  // 9: Next.PetKeyExperience.evolute_info:type_name -> Next.PetEvoluteInfo
	17,  // 10: Next.PetKeyExperience.pvp_first_win_info:type_name -> Next.PvpFirstWinInfo
	18,  // 11: Next.PetKeyExperience.legend_first_win_alone_info:type_name -> Next.LegendFirstWinAloneInfo
	19,  // 12: Next.PetKeyExperience.blessing_info:type_name -> Next.BlessingInfo
	20,  // 13: Next.PetKeyExperience.obtain_shiny_fashion_info:type_name -> Next.ObtainShinyFashionInfo
	21,  // 14: Next.PetKeyExperience.backtrack_record_info:type_name -> Next.PetBackTrackRecordInfo
	23,  // 15: Next.PetAdditionalNewAttrList.addi_attr_data:type_name -> Next.PetAdditionalNewAttrInfo
	25,  // 16: Next.PetClosenessInfo.history_info_list:type_name -> Next.PetClosenessHistoryInfo
	27,  // 17: Next.PetEvolutionNeedInfo.defeat_info:type_name -> Next.DefeatInfo
	28,  // 18: Next.PetEvolutionNeedInfo.interact_info:type_name -> Next.InteractInfo
	31,  // 19: Next.PetLLMSingleNatureTagInfo.tag_history:type_name -> Next.PetLLMTagHistoryInfo
	32,  // 20: Next.PetLLMNatureTagInfo.tag_info_list:type_name -> Next.PetLLMSingleNatureTagInfo
	33,  // 21: Next.PetSceneInfo.llm_nature_tag:type_name -> Next.PetLLMNatureTagInfo
	87,  // 22: Next.PetData.name_src:type_name -> dataconfig.PetNameSource
	88,  // 23: Next.PetData.skill_dam_type:type_name -> dataconfig.SkillDamType
	89,  // 24: Next.PetData.skill:type_name -> Next.PetSkillInfo
	11,  // 25: Next.PetData.ability:type_name -> Next.PetAbilityInfo
	9,   // 26: Next.PetData.attribute_info:type_name -> Next.PetAttributeInfo
	24,  // 27: Next.PetData.attribute_new_info:type_name -> Next.PetAdditionalNewAttrList
	0,   // 28: Next.PetData.evolution_stage:type_name -> Next.PetEvolutionState
	12,  // 29: Next.PetData.ai_info:type_name -> Next.BattleAIInitInfo
	14,  // 30: Next.PetData.possession:type_name -> Next.PossessionInfo
	90,  // 31: Next.PetData.cheer_info:type_name -> Next.CheerMonsterInitInfo
	15,  // 32: Next.PetData.stat:type_name -> Next.PetStatistics
	89,  // 33: Next.PetData.all_skill:type_name -> Next.PetSkillInfo
	22,  // 34: Next.PetData.key_experience:type_name -> Next.PetKeyExperience
	26,  // 35: Next.PetData.closeness_info:type_name -> Next.PetClosenessInfo
	91,  // 36: Next.PetData.partner_mark:type_name -> dataconfig.PetPartnerMarkType
	29,  // 37: Next.PetData.evlution_need_info:type_name -> Next.PetEvolutionNeedInfo
	92,  // 38: Next.PetData.glass_info:type_name -> Next.GlassInfo
	30,  // 39: Next.PetData.cheer_point_info:type_name -> Next.PetCheerPointInfo
	46,  // 40: Next.PetData.together_catch_info:type_name -> Next.TogetherCatchInfo
	39,  // 41: Next.PetData.type:type_name -> Next.PetTypeInfo
	36,  // 42: Next.PetData.activity_partner_pet_data:type_name -> Next.ActivityPartnerPetData
	1,   // 43: Next.PetData.nature_attr_change_way:type_name -> Next.PetNatureAttrChangeWay
	34,  // 44: Next.PetData.scene_info:type_name -> Next.PetSceneInfo
	93,  // 45: Next.PetData.season_add_info:type_name -> Next.SeasonBattleInfo
	83,  // 46: Next.PetData.pet_lord_info:type_name -> Next.PetLordInfo
	94,  // 47: Next.PetData.owl_sanctuary_pet_diff_info:type_name -> Next.OwlSanctuaryPetDiffInfo
	33,  // 48: Next.PetData.llm_nature_tag:type_name -> Next.PetLLMNatureTagInfo
	22,  // 49: Next.ActivityPartnerPetData.key_experience:type_name -> Next.PetKeyExperience
	26,  // 50: Next.ActivityPartnerPetData.closeness_info:type_name -> Next.PetClosenessInfo
	46,  // 51: Next.ActivityPartnerPetData.together_catch_info:type_name -> Next.TogetherCatchInfo
	88,  // 52: Next.TrialPetBrief.unit_type:type_name -> dataconfig.SkillDamType
	37,  // 53: Next.TrialPet.brief:type_name -> Next.TrialPetBrief
	35,  // 54: Next.TrialPet.pets:type_name -> Next.PetData
	7,   // 55: Next.PetTypeInfo.type:type_name -> Next.PetTypeInfo.ENUM
	43,  // 56: Next.PetEnvEnergyInfo.env_info:type_name -> Next.EnvEnergyInfo
	22,  // 57: Next.PetSpecialExData.key_experience:type_name -> Next.PetKeyExperience
	26,  // 58: Next.PetSpecialExData.closeness_info:type_name -> Next.PetClosenessInfo
	46,  // 59: Next.PetSpecialExData.together_catch_info:type_name -> Next.TogetherCatchInfo
	87,  // 60: Next.PetBriefInfo.name_src:type_name -> dataconfig.PetNameSource
	88,  // 61: Next.PetBriefInfo.skill_dam_type:type_name -> dataconfig.SkillDamType
	89,  // 62: Next.PetBriefInfo.skill:type_name -> Next.PetSkillInfo
	9,   // 63: Next.PetBriefInfo.attribute_info:type_name -> Next.PetAttributeInfo
	24,  // 64: Next.PetBriefInfo.attribute_new_info:type_name -> Next.PetAdditionalNewAttrList
	91,  // 65: Next.PetBriefInfo.partner_mark:type_name -> dataconfig.PetPartnerMarkType
	92,  // 66: Next.PetBriefInfo.glass_info:type_name -> Next.GlassInfo
	46,  // 67: Next.PetBriefInfo.together_catch_info:type_name -> Next.TogetherCatchInfo
	1,   // 68: Next.PetBriefInfo.nature_attr_change_way:type_name -> Next.PetNatureAttrChangeWay
	48,  // 69: Next.PetBacktrack.snap_shot:type_name -> Next.PetBriefInfo
	51,  // 70: Next.PetBacktrack.used_items:type_name -> Next.PetUsedItems
	50,  // 71: Next.PetBacktrack.show_info:type_name -> Next.PetBacktrackShowInfo
	88,  // 72: Next.PetBacktrackShowInfo.skill_dam_type:type_name -> dataconfig.SkillDamType
	92,  // 73: Next.PetBacktrackShowInfo.glass_info:type_name -> Next.GlassInfo
	87,  // 74: Next.PetBacktrackShowInfo.name_src:type_name -> dataconfig.PetNameSource
	48,  // 75: Next.PetTravelInfo.pet_briefs:type_name -> Next.PetBriefInfo
	54,  // 76: Next.PetStatisticsInfo_PetStatisticsData.mutation_count:type_name -> Next.MutationCount
	55,  // 77: Next.PetStatisticsInfo.pet_statistics_data:type_name -> Next.PetStatisticsInfo_PetStatisticsData
	35,  // 78: Next.PetDataInfoList.pet_data:type_name -> Next.PetData
	35,  // 79: Next.DeletedPetInfo.pet_data:type_name -> Next.PetData
	58,  // 80: Next.DeletedPetList.delete_pets:type_name -> Next.DeletedPetInfo
	95,  // 81: Next.PetSpecialData.skill_data:type_name -> Next.PetSkillData
	87,  // 82: Next.PetSpecialData.pet_name_src:type_name -> dataconfig.PetNameSource
	96,  // 83: Next.ReportInfo.rcr:type_name -> dataconfig.ReportCoinRatio
	48,  // 84: Next.PetReportInfo.pet_brief:type_name -> Next.PetBriefInfo
	61,  // 85: Next.PetReportInfo.report_infos:type_name -> Next.ReportInfo
	64,  // 86: Next.PetHabitInfo.habit_group:type_name -> Next.PetHabitGroup
	97,  // 87: Next.PetBox.mark_type:type_name -> dataconfig.WarehouseMarkType
	69,  // 88: Next.PetBackpackInfo.boxes:type_name -> Next.PetBox
	98,  // 89: Next.PetBackpackInfo.tidy_rules:type_name -> dataconfig.PetBoxTidyRuleType
	92,  // 90: Next.ZoneCatchResult.glass_info:type_name -> Next.GlassInfo
	75,  // 91: Next.RankSeasonPetUseInfo.pet_skill_use_info:type_name -> Next.PetSkillUseInfo
	78,  // 92: Next.PlayerPetMonitorInfo.daily_info:type_name -> Next.PlayerPetMonitorDailyInfo
	80,  // 93: Next.PetTaskInfo.together_task:type_name -> Next.PetTogetherTaskInfo
	92,  // 94: Next.SceneBasePetData.glass_info:type_name -> Next.GlassInfo
	34,  // 95: Next.SceneBasePetData.scene_info:type_name -> Next.PetSceneInfo
	87,  // 96: Next.SceneBasePetData.name_src:type_name -> dataconfig.PetNameSource
	33,  // 97: Next.SceneBasePetData.llm_nature_tag:type_name -> Next.PetLLMNatureTagInfo
	87,  // 98: Next.PetNameDetailData.name_src:type_name -> dataconfig.PetNameSource
	88,  // 99: Next.PetLordInfo.before_skill_dam_type:type_name -> dataconfig.SkillDamType
	84,  // 100: Next.GlassColorRandomInfo.color_list:type_name -> Next.ColorInfo
	99,  // 101: Next.PetBoxFilterItem.rule:type_name -> dataconfig.FilterRule
